  ...
  useEffect(() => {
    async function checkSession() {
      ...
      try {
        ...
        console.error(
          `[SessionPage] Error checking for session on date ${date}:`,
          error,
        );
        setHasSession(false);
      } finally {
        ...
        >
          ...
          >
            <div className="relative p-6">
              ...
              {/* Header */}
              <h2 className="text-3xl font-medium text-center mb-2 dark:text-gray-100">
                Ready to Focus?
              </h2>
              ...
              <div className="flex gap-4 mb-8">
                ...
                <div className="flex-1 bg-[#e4e9f7] dark:bg-gray-800 rounded-lg p-4 flex flex-col items-center justify-center text-center dark:text-gray-200">
                  <svg
                    className="h-10 w-10 text-blue-700 dark:text-blue-400 mb-2"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                ...
                <div className="flex-[2] bg-[#e4e9f7] dark:bg-gray-800 rounded-lg p-4 flex flex-col items-center justify-center text-center dark:text-gray-200">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-medium">
                      Est. completion:{" "}
                      <span className="font-semibold">{estimatedEnd}</span>
                    </p>
                  </div>
                </div>
              </div>
