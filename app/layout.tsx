...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${textMeOne.variable} ${happyMonkey.variable} ${nunitoSans.variable} ${inter.className}`}
      suppressHydrationWarning
    >
      <body
        className={`min-h-screen bg-background font-body antialiased theme-transition`}
      >
        <Providers>
          <ThemeProvider
            attribute="class"
