  ...
  ({
    ...
    return (
      <div className="flex items-center justify-center">
        ...
        >
          <span
            className={cn("timer-digit text-5xl", showRed && "timer-urgent")}
      ...
      <div className="p-5 flex flex-col items-center">
        ...
        <div className="w-full mb-2 text-center relative">
          <span
            ...
            className={cn(
              ...
              onGoToTimeline &&
                "hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline underline-offset-2",
            )}
          >
            {title}
            {onGoToTimeline && (
        ...
        {timeBoxType && (
          ...
          >
            {timeBoxType === "work"
              ? "Focus"
              : timeBoxType === "short-break"
                ? "Short Break"
                : timeBoxType === "long-break"
                  ? "Long Break"
                  : "Break"}
          </Badge>
        )}
        ...
        {isVisible && (
          <motion.div
            ...
            style={{
              ...
              minWidth: "240px",
              boxShadow:
                "0 0 25px rgba(0, 0, 0, 0.15), 0 0 15px rgba(99, 102, 241, 0.2)",
            }}
            ...
            whileHover={{
              boxShadow:
                "0 0 30px rgba(99, 102, 241, 0.4), 0 10px 25px rgba(0, 0, 0, 0.2)",
              scale: 1.02,
...
const FloatingTimerWrapper = React.memo(
  ({
    ...
    const [localFormattedTime, setLocalFormattedTime] =
      useState(initialFormattedTime);
...
export const SessionView = ({ id, date, storageService }: SessionViewProps) => {
  ...
  const springOpacity = useSpring(floatingTimerOpacity, {
    damping: 30,
    stiffness: 400,
  });
  const springScale = useSpring(floatingTimerScale, {
    damping: 20,
    stiffness: 300,
  });
  ...
  const getActiveTimeBoxDetails = useCallback(() => {
    ...
    const timeBox =
      session.storyBlocks[storyIndex].timeBoxes[activeTimeBox.timeBoxIndex];
  ...
  useMotionValueEvent(scrollY, "change", () => {
    ...
    const timerTopPercent = Math.max(
      0,
    ...
    isFloatingTimerShown.current =
      !shouldBeVisible && activeTimeBox !== null && timeRemaining !== null;
  });
  ...
  const getSessionStatusBadge = () => {
    ...
    if (isSessionComplete) {
      return (
        <Badge
          variant="outline"
          className="bg-green-50 dark:bg-green-950/40 text-green-700 dark:text-green-300 border-green-200 dark:border-green-700/60"
        >
    ...
    if (activeTimeBox) {
      return (
        <Badge
          variant="outline"
          className="bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-700/60"
        >
    ...
    return (
      <Badge
        variant="outline"
        className="bg-yellow-50 dark:bg-yellow-950/40 text-yellow-700 dark:text-yellow-300 border-yellow-200 dark:border-yellow-700/60"
      >
  ...
  useEffect(() => {
    const shouldShow =
      ...
      activeTimeBox !== null &&
      timeRemaining !== null &&
      isFloatingTimerInitialized.current;
        ...
        <Card className="border-2 xl:col-span-2">
          <CardHeader className="pb-3">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-2">
              <Badge
                variant="outline"
                className="px-3 py-1 flex items-center gap-1.5 bg-white dark:bg-gray-900/80 border-gray-200 dark:border-gray-700/60 text-gray-700 dark:text-gray-300"
              >
              ...
              <Badge
                variant="outline"
                className="px-3 py-1 flex items-center gap-1.5 bg-secondary/20 border-secondary/30"
              >
                <Icon icon={CheckCircle2} color="default" size="sm" />
                <span>
              ...
              >
                ...
                <span>
                  Breaks: {Math.floor(breakDuration / 60)}h {breakDuration % 60}
                  m
                </span>
              </Badge>
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 mb-1 mt-1">
              ...
              <div className="bg-violet-50 dark:bg-violet-950/30 border border-violet-200 dark:border-violet-800/50 rounded-lg p-3 flex flex-col items-center">
                ...
                <span className="text-xs font-medium text-violet-600 dark:text-violet-400 mb-1">
                  Frogs Completed
                </span>
                <span className="text-lg font-bold">
                  ...
                  <span className="text-sm font-medium text-violet-500/70 dark:text-violet-400/70">
                    {" "}
                  ...
                  {session.storyBlocks.reduce(
                    (sum, story) =>
                      ...
                      story.timeBoxes.reduce(
                        (boxSum, box) =>
                          boxSum +
                          (box.tasks?.filter((t) => t.status === "completed")
                            .length || 0),
                        0,
                      ),
                    0,
              ...
              <div className="bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-200 dark:border-indigo-800/50 rounded-lg p-3 flex flex-col items-center">
                ...
                <span className="text-lg font-bold">
                  {completedPercentage}%
                  <span className="text-sm font-medium text-indigo-500/70 dark:text-indigo-400/70">
                    {" "}
                    completed
                  </span>
                </span>
              ...
              {showTimeAdjust && (
                ...
                >
                  <div className="border border-transparent rounded-lg p-3 bg-transparent">
                    <h4 className="text-xs font-medium text-center mb-2 text-muted-foreground">
                      Add/Remove Time
                    </h4>
                    <div className="flex justify-center items-center gap-2 mx-auto">
                      ...
                      <Button
                        ...
                        onClick={() => adjustTimer(1)}
                      >
                        <span className="mr-0.5 text-[10px] font-bold">
                          +1m
                        </span>
                    ...
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        onClick={() =>
                          activeTimeBox &&
                          completeTimeBox(
                            activeTimeBox.storyId,
                            activeTimeBox.timeBoxIndex,
                          )
                        }
      ...
      <div className="mt-8" ref={timelineRef}>
        <Card className="border">
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Track your progress through the session with this interactive
              timeline
            </CardDescription>
          </CardHeader>
