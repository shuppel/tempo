...
import { useWorkPlan, type UseWorkPlanReturn } from "../hook/useWorkPlan"
import { TodoWorkPlanService } from "../services/session-storage.service"
...
interface WorkPlanViewProps {
  id?: string;
  date?: string;
  storageService?: TodoWorkPlanService;
}
...
const WorkPlanView: React.FC<WorkPlanViewProps> = ({ 
  ...
  storageService = new TodoWorkPlanService()
}) => {
