...
import { TimeboxView } from "@/app/features/session-manager/components/timebox-view";
...
import { useTasks } from "@/app/features/task-persistence/hooks/useTasks";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2
          ...
          dangerouslySetInnerHTML={{ __html: escapeHtml("Today's Tasks") }}
        />
        ...
        <div
          className={cn(
            ...
            loadingState.generating &&
              "animate-out fade-out-50 slide-out-to-right-1",
          )}
        >
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <p>
              Total Duration: {Math.floor(sessionPlan.totalDuration / 60)} hours{" "}
              {sessionPlan.totalDuration % 60} minutes
            </p>
            <Progress
              value={
        ...
        <div className="rounded-lg border border-dashed p-8 text-center animate-in fade-in-50">
          ...
          <p
            ...
            dangerouslySetInnerHTML={{
              __html: escapeHtml(
                "Add a task to get started with your Pomodoro session. Don&apos;t forget to plan breaks!",
              ),
            }}
          />
        </div>
